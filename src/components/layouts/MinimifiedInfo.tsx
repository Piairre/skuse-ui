...
import { Home, Check, ChevronsUpDown, SlidersHorizontal, Menu } from 'lucide-react';
...
const MinimifiedInfo: React.FC<MinimifiedInfoProps> = ({ onToggleSidebar }) => {
    ...
    return (
        <div className="bg-muted/60 backdrop-blur-md sticky top-0 z-50 w-full shadow-sm">
            <div className="flex flex-col md:flex-row md:items-center md:h-16 px-4 py-2 md:py-0 gap-2 md:gap-3">
                {/* Row 1 on mobile: burger + home + title */}
